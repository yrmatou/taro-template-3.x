...
import selectedImg from '@/assets/images/tab-bar/index.png'
...
const defaultConfig = {
  ...
  images: [
    { // 车辆头图
      ...
      width: 690,
      height: 500,
      url: 'http://public.custcome.com/commons_service/d897418a20f946f192ec3f93c5ef03c51634476388412.jpg',
      zIndex: 20,
    },
    // 个人二维码
    {
  ...
  return (
    <View>
      ...
      <View>
        ...
        <Button onClick={beginDraw}>绘制海报</Button>
